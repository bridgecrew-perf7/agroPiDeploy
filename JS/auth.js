...
const register = (redirectURL) => {
    ...
    axios.post('https://agropiproject.herokuapp.com/register/', {username, email, password})
        .then(res => {
            console.log(res)
            return res
        })
...
const login = (redirectURL) => {
    ...
    axios.post('https://agropiproject.herokuapp.com/login/', {username, email, password})
        .then(res => {
            return res.data
        })
        .then(data => {
